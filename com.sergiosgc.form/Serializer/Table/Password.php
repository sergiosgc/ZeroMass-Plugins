...
/** 
 * Serializer_Table_Password is an input serializer to xhtml that produces code according to Table's accessible forms article
 * for a description of the structure
 */
class Serializer_Table_Password
{
...
<input type="password" id="%s" name="%s" value="%s" class="text" />
